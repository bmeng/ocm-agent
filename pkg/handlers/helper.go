...
type OCMClient interface {
	SendServiceLog(n *oav1alpha1.Notification, firing bool, clusterId string) error
}
...
func (o *ocmsdkclient) SendServiceLog(n *oav1alpha1.Notification, firing bool, clusterId string) error {
	req := o.ocm.Post()
